...
<link rel="stylesheet" type="text/css" href="styles.css"></link>
	...
	<div class="content">
     <br/><br/>
     <fieldset>
          <form method="post" action="OrderManagementController" name="confirmUserForm" onsubmit="return validate()">
             <table>
                <tr> <th> Select a status </th>  <td> <select name="status">  
                ...
                <tr> <td> <input type="hidden" name="action" value="viewOrders">  </td>
           </table>
           </form>
           </fieldset>
          </div>
